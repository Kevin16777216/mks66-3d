...
void add_sphere( struct matrix * edges, 
    ...
    int point;
    for (point=0; (point+step+1) < sphere->lastcol-1; point++){
      if(point%(step+1) != step){
        ...
        add_edge(edges, sphere->m[0][point],sphere->m[1][point],sphere->m[2][point],
                        sphere->m[0][point+step+1],sphere->m[1][point+step+1],sphere->m[2][point+step+1]);
      }
    }
}
